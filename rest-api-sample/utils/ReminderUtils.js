...
(function(factory) {
    ...
    module.exports = factory(require('../../dist/adobe-sign-sdk'), require('../utils/AgreementUtils'), require('./Errors'), require('./ApiUtils'), require('./Constants'));
  
}(function(AdobeSignSdk, AgreementUtils, Errors, ApiUtils, Constants) {
  'use strict';
