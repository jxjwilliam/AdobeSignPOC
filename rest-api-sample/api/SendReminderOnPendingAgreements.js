...
(function(factory) {
    ...
    module.exports = factory(require('../../dist/adobe-sign-sdk'), require('../utils/ReminderUtils'), require('../utils/AgreementUtils'), require('../utils/Constants'), require('../utils/Errors'), require('../utils/ApiUtils'));
